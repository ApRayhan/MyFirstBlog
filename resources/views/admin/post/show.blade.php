...
@section('content')
	<div class="container-fluid">
            ...
            <div class="row clearfix">
                ...
                @else
                    <button type="button" class="btn btn-primary pull-right" onclick="approvedpost({{$post->id}})">
                        <i class="material-icons">done</i> Approve
                    </button><br><br>
                @endif

                    <form action="{{ route('admin.approved.post', $post->id) }}" method="post" id="approvedpost" style="display: none">
                        @csrf
                        @method('PUT')
                    </form>
    ...
    function approvedpost(id) {
            swal({
                ...
                if (result.value) {
                    ...
                    document.getElementById('approvedpost').submit();
                } else if (
